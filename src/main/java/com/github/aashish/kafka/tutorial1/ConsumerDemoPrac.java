...
public class ConsumerDemoPrac {
    public static void main(String[] args) {

        String bootstrapServer = "127.0.0.1:9092";
        String groupId = "my-application-1";
        String topic = "first_topic";
        Logger logger = LoggerFactory.getLogger(ConsumerDemoPrac.class);
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                logger.info("Message is : " + record.value());
                logger.info("Topic is : " + record.topic());
                logger.info("Offset number is : " + record.offset());
