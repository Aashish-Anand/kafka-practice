...
public class ConsumerDemo {
    public static void main(String[] args) {
        ...
        // if you alredy produced the data way before then
        // the consumer consumes the data from partition sequentially i.e
        // start from partition 0 then partition 1 then partition 2

        // otherwise if you producing data side by side then
        // you will get the data as published by the producer
    }
}
